    ...
    state = {
        content: [
            ...
            },
            {
                ...
                "subheading": "",
                "content": "Midalta Innovations maintains a strong network of regional and international experts who collaborate to solve our clients’ most complex challenges. Our capabilities network enables us to draw on a vast pool of knowledge, providing clients with access to cutting-edge strategies, industry best practices, and tailored solutions that are informed by local and global insights."
            },
            {
                "layout": "leftImage",
    ...
    render() {
        return (
            <>
                ...
                <PageTitleArea
                    pageTitle="About Us"
                    pageDescription="At Midalta Innovations, we are more than just a consulting firm. We are a global team of problem-solvers, strategic thinkers, and hands-on implementers who are deeply committed to helping our clients overcome challenges and unlock new growth opportunities. Our unique position in the USA, Africa, and the Caribbean allows us to offer local expertise with global insights, empowering businesses and governments to navigate complex markets and industries."
                />
                <AboutContent />
